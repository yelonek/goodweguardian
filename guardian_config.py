...
# Blend k_intra z estymatą rate (średnia moc z ostatnich N min) — lepsze łapanie chmur w środku h
PV_CORRECTION_RATE_ENABLED = _bool_env("PV_CORRECTION_RATE_ENABLED", True)
PV_CORRECTION_RATE_WINDOW_MIN = _int_env("PV_CORRECTION_RATE_WINDOW_MIN", 15)
PV_CORRECTION_RATE_BLEND_START = _float_env("PV_CORRECTION_RATE_BLEND_START", 0.2)
PV_CORRECTION_RATE_BLEND_END = _float_env("PV_CORRECTION_RATE_BLEND_END", 0.7)
# Dynamiczny clip: wąski na początku h, szeroki pod koniec (łapie duże błędy Solcast)
PV_CORRECTION_DYNAMIC_CLIP_ENABLED = _bool_env("PV_CORRECTION_DYNAMIC_CLIP_ENABLED", True)
PV_CORRECTION_K_MIN_WIDE = _float_env("PV_CORRECTION_K_MIN_WIDE", 0.2)
PV_CORRECTION_K_MAX_WIDE = _float_env("PV_CORRECTION_K_MAX_WIDE", 3.0)
PV_CORRECTION_CLIP_RAMP_START = _float_env("PV_CORRECTION_CLIP_RAMP_START", 0.15)
PV_CORRECTION_CLIP_RAMP_END = _float_env("PV_CORRECTION_CLIP_RAMP_END", 0.55)
